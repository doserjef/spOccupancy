...
# Spatial REs specified across a grid -------------------------------------
# TODO: you likely need to save some example for doing this, or do it with the 
#       raw data. The way you have simulated is reliant on tidyverse, which 
#       you of course do not want to be.
# J.x <- 8
# J.y <- 8
# J <- J.x * J.y
# n.rep <- sample(2:4, J, replace = TRUE)
