tMsPGOcc <- function(occ.formula, det.formula, data, inits, priors, 
  ...
  if (parallel.chains) {
    ...
    out.tmp <- foreach(i = 1:n.chains) %dorng% {
      .Call("tMsPGOcc", y, X, X.p, X.re, X.p.re, consts, 
            n.occ.re.long, n.det.re.long, beta.inits.list[[i]], 
            alpha.inits.list[[i]], z.inits, beta.comm.inits.list[[i]], 
            alpha.comm.inits.list[[i]], tau.sq.beta.inits.list[[i]], 
            tau.sq.alpha.inits.list[[i]], sigma.sq.psi.inits.list[[i]], sigma.sq.p.inits.list[[i]], 
            ...
            sigma.sq.p.a, sigma.sq.p.b, ar1, ar1.vals.list[[i]],
