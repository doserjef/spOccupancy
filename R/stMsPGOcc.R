    ...
    if (parallel.chains) {
      ...
      out.tmp <- foreach(i = 1:n.chains) %dorng% {
        .Call("stMsPGOccNNGP", y, X, X.p, 
              ...
              beta.star.inits.list[[i]], alpha.star.inits.list[[i]], 
              z.long.indx, z.year.indx, z.dat.indx, z.site.indx,
              ...
              samples.info, chain.info, ar1.vals.list[[i]], grid.index.c)
      }
